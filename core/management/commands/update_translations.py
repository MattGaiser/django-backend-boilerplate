...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                _("Updating translation files for languages: {}").format(
                    ", ".join(languages)
                )
            )
        )
        ...
        for language in languages:
            ...
            try:
                ...
                self.stdout.write(
                    self.style.ERROR(
                        _("✗ Error updating messages for {}: {}").format(language, e)
                    )
                )
        ...
        self.stdout.write(self.style.SUCCESS(_("Translation update completed!")))
