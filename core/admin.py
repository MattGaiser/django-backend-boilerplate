...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('email', 'full_name', 'is_active', 'is_staff', 'is_superuser', 'is_experimental_user_override', 'date_joined')
    list_filter = ('is_active', 'is_staff', 'is_superuser', 'is_experimental_user_override', 'date_joined')
    ...
    fieldsets = (
        ...
        (_('Feature Flags'), {
            ...
            'description': _('Experimental user override only works for superusers')
        }),
...
class OrganizationAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'is_active', 'is_experimental', 'created_at', 'member_count')
