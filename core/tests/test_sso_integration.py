...
class TestAllauthConfiguration(TestCase):
    ...
    def test_allauth_installed_and_configured(self):
        ...
        self.assertIn('allauth.socialaccount.providers.microsoft', settings.INSTALLED_APPS)
    ...
    def test_custom_adapters_configured(self):
        ...
        self.assertEqual(settings.SOCIALACCOUNT_ADAPTER, 'core.adapters.CustomSocialAccountAdapter')
...
class TestCustomSocialAccountAdapter(TestCase):
    ...
    def test_is_open_for_signup_default(self):
        ...
        social_login = type('MockSocialLogin', (), {
