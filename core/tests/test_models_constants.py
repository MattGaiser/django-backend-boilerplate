...
class TestOrganizationWithConstants(TestCase):
    ...
    def test_organization_plan_choices(self):
        ...
        org = Organization.objects.create(
            name="Test Org", plan=PlanChoices.STANDARD, created_by=self.user
        )
    ...
    def test_organization_language_choices(self):
        ...
        org = Organization.objects.create(
            name="Test Org", language=LanguageChoices.FRENCH, created_by=self.user
        )
    ...
    def test_get_plan_limits(self):
        ...
        org_free = Organization.objects.create(
            name="Free Org", plan=PlanChoices.FREE, created_by=self.user
        )
        ...
        org_enterprise = Organization.objects.create(
            name="Enterprise Org", plan=PlanChoices.ENTERPRISE, created_by=self.user
        )
    ...
    def test_is_premium_plan(self):
        ...
        org_standard = Organization.objects.create(
            name="Standard Org", plan=PlanChoices.STANDARD, created_by=self.user
        )
    ...
    def test_can_add_users(self):
        ...
        org = Organization.objects.create(
            name="Test Org", plan=PlanChoices.FREE, created_by=self.user
        )

        # Create membership for the creator
        OrganizationMembership.objects.create(
            user=self.user, organization=org, created_by=self.user
        )
        ...
        for i in range(3):
            ...
            OrganizationMembership.objects.create(
                user=user, organization=org, created_by=self.user
            )
...
class TestUserWithConstants(TestCase):
    ...
    def test_get_effective_language_org_default(self):
        ...
        org = Organization.objects.create(
            name="French Org", language=LanguageChoices.FRENCH, created_by=user
        )

        membership = OrganizationMembership.objects.create(
            user=user, organization=org, is_default=True, created_by=user
        )
...
class TestConstantsIntegration(TestCase):
    ...
    def test_organization_plan_display(self):
        ...
        org = Organization.objects.create(
            name="Test Org", plan=PlanChoices.STANDARD, created_by=user
        )
