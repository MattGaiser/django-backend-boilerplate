    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_joined', models.DateTimeField(default=django.utils.timezone.now, help_text='Date when the user joined')),
                ('language', models.CharField(blank=True, default='en', help_text='Preferred language code', max_length=10)),
                ('timezone', models.CharField(blank=True, default='UTC', help_text="User's timezone", max_length=50)),
                ('last_login_ip', models.GenericIPAddressField(blank=True, help_text="IP address of the user's last login", null=True)),
