        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Designates whether this project is active",
                    ),
                ),
                (
                    "start_date",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["name", "is_active"], name="core_projec_name_54f204_idx"
                    ),
                    models.Index(
                        fields=["status"], name="core_projec_status_2020cc_idx"
                    ),
                ],
            },
        ),
