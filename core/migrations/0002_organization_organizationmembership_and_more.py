...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Name of the organization", max_length=255
                    ),
                ),
                (
                    "description",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "is_default"], name="core_organi_user_id_6af01c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="organizationmembership",
            index=models.Index(
                fields=["organization", "role"], name="core_organi_organiz_42bdab_idx"
            ),
        ),
